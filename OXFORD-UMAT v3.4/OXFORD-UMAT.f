...
!     local array for 3D crystal plasticity solver
      real(8) :: sigma(6), jacobi(6,6), elas(6,6)
...
!                 Corrected stress for plane stress
                  STRESS=0.
                  STRESS(1) = sigma(1)
     + -elas(1,3)*sigma(3)/elas(3,3)
     + -elas(1,5)*sigma(5)/elas(5,5)
     + -elas(1,6)*sigma(6)/elas(6,6)
!
                  STRESS(2) = sigma(2)
     + -elas(2,3)*sigma(3)/elas(3,3)
     + -elas(2,5)*sigma(5)/elas(5,5)
     + -elas(2,6)*sigma(6)/elas(6,6)
!
                  STRESS(3) = sigma(4)
     + -elas(4,3)*sigma(3)/elas(3,3)
     + -elas(4,5)*sigma(5)/elas(5,5)
     + -elas(4,6)*sigma(6)/elas(6,6)
!
